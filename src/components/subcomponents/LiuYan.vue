<template>
  <div class="cmt-container">
     <h3>发表留言</h3> 
    <hr>
    <textarea placeholder="请输入要留言的内容（做多留言120字）" maxlength="120" v-model="msg"></textarea>

    <!-- <mt-button type="primary" size="large">发表评论</mt-button> -->
    <mt-button type="primary" size="large" @click="postComment">发表留言</mt-button> 
    <div class="cmt-list">
      ...
      this.$http
        ...
        .then(function(result) {
          if (result.body.status === 0) {
            ...
            this.comments.unshift(cmt);//数组的unshift方法
            this.msg = "";
          }
          console.log(result)
