<template>
  <div class="app-container">
    ...
    <!-- 中间的 路由 router-view 区域切换，所以用transition包起来 -->
    <!-- transition组件切换时候的动画效果 -->
		<transition>
			<router-view></router-view>
		</transition>
<!-- 
		<router-link> 就是定义页面中点击的部分，<router-view> 定义显示部分，就是点击后，区配的内容显示在什么地方。
	所以 <router-link> 还有一个非常重要的属性 to，定义点击之后，要到哪里去  to的地方就是组件-->
...
// 该类名，解决 tabbar 点击无法切换的问题，将跟mui-tab-item有关的都替换成mui-tab-item-llb
